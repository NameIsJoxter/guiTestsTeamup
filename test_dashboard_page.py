...
from pages.calendar_create_page import CalendarCreatePage
...
class TestUserCanCreateCalendarFromDashboardPage:
    ...
    def test_user_can_open_create_calendar_page(self, driver):
        ...
        page = CalendarCreatePage(driver, driver.current_url)
    ...
    def test_user_can_create_calendar(self, driver):
        ...
        page = CalendarCreatePage(driver, CalendarCreatePage.link)
